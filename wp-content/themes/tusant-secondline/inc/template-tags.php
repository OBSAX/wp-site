...
function secondline_themes_logo() {
	global $post;
?>
	<?php if ( get_theme_mod( 'secondline_themes_one_page_nav') == 'on') : ?><a href="#main-container-secondline" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" class="scroll-to-link"><?php else: ?><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php endif ?>
