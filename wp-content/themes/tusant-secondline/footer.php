...
?>
	...
	<?php if (get_theme_mod( 'secondline_themes_footer_elementor_library') && !is_singular( 'elementor_library') ) : ?>
		<div id="tusant-footer-page-builder">
			<?php if(is_page() && get_post_meta($post->ID, 'tusant_disable_footer_per_page', true)): ?><?php else: ?>
			<?php
